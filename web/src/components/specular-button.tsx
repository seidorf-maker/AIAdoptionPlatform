...
// SpecularButton from React Bits (https://reactbits.dev), adapted to
// TypeScript. A glassy button with a WebGL specular rim highlight (via ogl)
// that steers toward the cursor. Renders a native <button>; pass onClick to
// wire up navigation. Best on dark surfaces (here: the landing aurora band).
