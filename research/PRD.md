...
**Market sizing (pitch context):** figures marked **[sourced]** trace to a specific, checkable source (see the Sources list below); figures marked **[modeled]** are estimates built on top of those sourced inputs, not independent measurements. This subsection was re-verified against primary sources on 2026-07-28 (via live web research) — an earlier draft cited a "67%/33%" adoption-vs-training statistic and a "SAP UK" figure that could not be traced to any locatable source. A first correction pass replaced those with real 2025 sources, but was itself flagged as too dated — every AI-adoption figure below now leads with the most current publicly available data at time of writing (mid-2026 Gallup and Census Bureau releases), not just "not before 2024."

- TAM: ~20,868 U.S. companies had 500+ employees, out of ~6.1M total U.S. employer firms **[sourced — U.S. Census Bureau 2019 data, as cited by the U.S. Small Business & Entrepreneurship Council; see Sources]**. This is the most recent single published count found — no cleanly-stated updated total was located — but the Census Bureau's own most recent County Business Patterns release (2023 data) puts firms with fewer than 500 employees at 5.58M, or 99.7% of U.S. employer firms, meaning the large-employer share has stayed effectively flat since 2019: the order of magnitude is still current even though the precise count is a 2019 vintage.
- The cost of the status quo, leading with the most current data available: Gallup's Q2 2026 workforce survey (n=22,573, fielded May 2026) found **47%** of U.S. employees now say their organization has integrated AI tools — up from 41% the prior quarter — and individual use has climbed to **52%** of U.S. workers, with only 30% using it frequently and 15% daily **[sourced — Gallup, "Organizational AI Adoption Jumps Six Points," published July 20, 2026; see Sources]**. But rollout is outpacing governance: Gallup's mid-2025 measurement found only **30%** of companies had any formal AI-use guidelines even as 44% had already begun integrating AI — a gap that a 2025 47-country study corroborates from a different angle: only **42%** of employees use the AI tools their employer actually provides, while 70% reach for free public tools instead **[sourced — Gallup, June 2025, and Melbourne Business School/University of Melbourne, 2025; see Sources]**. The Census Bureau's own biweekly Business Trends and Outlook Survey confirms this at the company level: as of May 2026, only **19.8%** of U.S. businesses report using AI in operations nationally — 37% among firms with 250+ employees, still well under half **[sourced — U.S. Census Bureau, "Large Firms With at Least 20 Employees Biggest AI Users," May 26, 2026; see Sources]**. At enterprise L&D seat pricing (LinkedIn Learning Teams: **$379.88/user/year**, LinkedIn's own published pricing **[sourced]**), a 4,200-employee company spends roughly $1.6M/year on training seats; even a conservative assumption that half of that isn't reaching employees in a governed, sanctioned way (per the adoption-vs-governance gap above) points to **~$800K/year in training spend that isn't reliably converting into sanctioned, demonstrated skill at a single mid-size company [modeled estimate — an illustrative order of magnitude, not an audited number for any real company]**.
- Opportunity: comparable enterprise corporate-learning pricing commonly runs **$250–500/user/year** (e.g., Coursera for Business enterprise tier) **[sourced — Vendr buyer-side contract-pricing data; see Sources]**. OnRamp is modeled below that band, at **~$96/user/year [modeled]**. At ~210 target companies averaging ~2,000 enrolled employees each: **420,000 seats × $96/year ≈ $40M in annual revenue potential at full capture [modeled build-up, not a Year 1 number]**.
- **One-line version:** *"As of mid-2026, nearly half of U.S. companies say they've rolled out AI — but Census Bureau data shows fewer than 1 in 5 businesses actually use it in operations, and Gallup finds most companies still have no formal policy for how employees should use it. At typical L&D pricing, that gap can mean hundreds of thousands of dollars a year in training spend that isn't converting into sanctioned, demonstrated skill at a single mid-size company. OnRamp doesn't ask companies to spend more — it makes the seats they've already bought actually work."*

**Sources (market sizing, all re-verified 2026-07-28 for currency):**
- Gallup, "Organizational AI Adoption Jumps Six Points" (Andy Kemp, July 20, 2026) — https://www.gallup.com/workplace/712736/organizational-adoption-jumps-six-points.aspx (Gallup Panel, US employed adults, n=22,573, Q2 2026 survey May 6–20 2026, ±0.9pp)
- Gallup, "AI Use at Work Has Nearly Doubled in Two Years" (Ryan Pendell, June 15, 2025) — https://www.gallup.com/workplace/691643/work-nearly-doubled-two-years.aspx (source for the formal-AI-policy governance-gap figure)
- U.S. Census Bureau, "Large Firms With at Least 20 Employees Biggest AI Users" (Business Trends and Outlook Survey, May 26, 2026) — https://www.census.gov/library/stories/2026/05/ai-use-businesses.html
- Melbourne Business School / University of Melbourne, "Trust, attitudes and use of artificial intelligence: A global study 2025" — https://mbs.edu/faculty-and-research/trust-and-ai/key-findings-on-ai-at-work-and-in-education (47-country global study)
- LinkedIn Learning, official pricing — https://business.linkedin.com/learn/compare-plans
- U.S. Small Business & Entrepreneurship Council, "Facts & Data," citing U.S. Census Bureau 2019 data — https://sbecouncil.org/about-us/facts-and-data/
- U.S. Census Bureau, County Business Patterns (2023 release, firm counts by size) — https://www.census.gov/programs-surveys/cbp.html
- Vendr, Coursera for Business pricing (buyer-side contract data) — https://www.vendr.com/marketplace/coursera-e79d6
